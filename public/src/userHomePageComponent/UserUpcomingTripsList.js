...
class UserUpcomingTripsList extends Component {
  ...
  render() {
    return (
    //Gridlist is a material-ui method. Looks nice. Like my booty.
    ...
    >
      ...
      {this.state.upcomingTrips.map((tile) => (
        <GridTile
          ...
          actionIcon={
            <div>
            <Avatar
          src="http://industribune.net/wp-content/uploads/2015/02/industribune-default-no-profile-pic.jpg"
          size={50}
